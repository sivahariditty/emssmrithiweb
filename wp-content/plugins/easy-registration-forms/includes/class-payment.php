...
{   
    ...
    public function save_settings($options){
      $options['send_offline_email'] =   isset($_POST['send_offline_email']) ? 1 : 0;
      $options['offline_email'] =   wp_kses_post(stripslashes($_POST['offline_email']));
      ...
      $options['payment_pending_email'] =   isset($_POST['payment_pending_email']) ? $_POST['payment_pending_email'] : '';
      $options['pending_pay_email_from'] =   sanitize_text_field($_POST['pending_pay_email_from']);
      $options['pending_pay_email_from_name'] =   sanitize_text_field($_POST['pending_pay_email_from_name']);
      $options['pending_pay_email_subject'] =   sanitize_text_field($_POST['pending_pay_email_subject']);
      
      $options['en_payment_completed_email'] =   isset($_POST['en_payment_completed_email']) ? 1 : 0;
      $options['payment_completed_email'] =   isset($_POST['payment_completed_email']) ? $_POST['payment_completed_email'] : '';
      $options['completed_pay_email_from'] =   sanitize_text_field($_POST['completed_pay_email_from']);
      $options['completed_pay_email_from_name'] =   sanitize_text_field($_POST['completed_pay_email_from_name']);
      $options['completed_pay_email_subject'] =   sanitize_text_field($_POST['completed_pay_email_subject']);
