            ...
            <form action="" method="post" class="erf-login-form erf-form">
                <div class="fb-text form-group">
                    <label for="erf_username" class="fb-text-label">
                        <?php echo $username_label; ?><span class="fb-required">*</span>
                    </label>

                    <input required="" placeholder="<?php echo $attr['label_position'] == 'no-label' ? $username_label : ''; ?>" value="<?php echo isset($_POST['erf_username']) ? $_POST['erf_username'] : ''; ?>" type="text" class="form-control" id="erf_username" name="erf_username">
                </div>
                ...
                <div class="fb-text form-group">
                    ...
                    <input placeholder="<?php echo $attr['label_position'] == 'no-label' ? __('Password', 'erforms') : ''; ?>" type="password" value="<?php echo isset($_POST['erf_password']) ? $_POST['erf_password'] : ''; ?>" required="" class="form-control" id="erf_password" name="erf_password">
                </div>
