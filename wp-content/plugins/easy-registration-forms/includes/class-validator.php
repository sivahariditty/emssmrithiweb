    ...
    public function validate_data($fields= array(),$data){
        ...
        foreach($fields as $field){
            ...
            if($field->type=="date"){
                ...
                if(isset($field->max) && isset($data[$field->name]) && !ERForms_Validation::maxDate($data[$field->name],$field->max,$field_date_pattern)){
                ...
                if(isset($field->min) && isset($data[$field->name]) && !ERForms_Validation::minDate($data[$field->name],$field->min,$field_date_pattern)){
            ...
            if(isset($data[$field->name]) && method_exists('ERForms_Validation',$field->type)){
				$ftype= $field->type;
                if($field->type=='text'){
                    if(!ERForms_Validation::$ftype($field->subtype,$data[$field->name])){
