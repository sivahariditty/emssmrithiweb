...
class ERForms_Submission_Table extends ERForms_List_Table {
	...
	public function column_default( $submission_id, $column_name ) {
                ...
                if($column_name=='payment_status' && !empty($form['plan_enabled'])){
	...
	public function prepare_items() {
		...
		$form= $this->get_form();
			...
			'no_found_rows'  => false,
                    ...
                    if(!empty($value))
                    {
                        $post_query['erf_meta_content_s']= $value;
                    }
		...
		<select name="<?php echo $dd_name; ?>" id="<?php echo $dd_name; ?>">
			<option value=""><?php _e( 'Change Form' ) ?></option>
                ...
                <?php if($which=='top'): ?>
                            ...
                            <?php endif; ?>
                            <input type="text" value="<?php echo $from_date; ?>" class="erf-filter-date" placeholder="<?php _e('From Date','erforms'); ?>" name="from_date" />
                            <input type="text" value="<?php echo $end_date; ?>" class="erf-filter-date" placeholder="<?php _e('End Date','erforms'); ?>" name="end_date" />
                <?php endif; ?>
	<?php
