...
<?php if(!empty($form)): ?>
    <div id="erf_change_subs_cols_dialog" class="erf_dialog fade" style="display: none;">
        <div class="modal-dialog">    
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="">
                        ...
                        <select id="erf_sub_columns" multiple="" class="erf-input-field">
                            ...
                            ?>
                            <option <?php echo in_array($field['name'],$form['sub_columns']) ? 'selected' : ''; ?> value="<?php echo $field['name']; ?>"><?php echo $field['label']; ?></option>
                            <?php endforeach; ?>
                        </select>
                ...
                <div class="modal-footer">
                    <button type="button" id="erf_change_sub_cols_btn" data-form-id="<?php echo $form['id']; ?>" class="button button-primary"><?php _e('Save','erforms'); ?></button>
                </div>
            </div>
        </div>
    </div>
