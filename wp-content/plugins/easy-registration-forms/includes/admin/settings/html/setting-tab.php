            ...
            <fieldset>
                <div style="<?php echo $tab == 'general' ? '' : 'display:none' ?>">
                    ...
                    <div class="erf-row">
                        ...
                        <div class="erf-control">
                            <input pattern="^[A-Za-z-_]+$" type="text" class="erf-input-field" name="upload_dir" value="<?php echo $options['upload_dir']; ?>" />
                ...
                <div style="<?php echo $tab == 'user_login' ? '' : 'display:none' ?>">
                    ...
                    <div class="erf-row">
                        ...
                        <div class="erf-control">
                            <input type="url" class="erf-input-field" name="after_login_redirect_url" value="<?php echo $options['after_login_redirect_url'] ?>" />
                    ...
                    <div class="erf-child-rows" style="<?php echo!empty($options['en_role_redirection']) ? '' : 'display:none'; ?>">
                        ...
                        <?php foreach ($roles as $key => $role): ?>
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input type="text" class="erf-input-field" value="<?php echo $options[$key . '_login_redirection'] ?>" name="<?php echo $key ?>_login_redirection" />
                    ...
                    <div class="erf-row">
                        ...
                        <div class="erf-control erf-has-child">
                            <input type="text" class="erf-input-field" value="<?php echo $options['logout_redirection'] ?>" name="logout_redirection" />
                ...
                <div style="<?php echo $tab == 'external' ? '' : 'display:none' ?>">
                    ...
                    <div class="erf-child-rows" style="<?php echo!empty($options['recaptcha_configured']) ? '' : 'display:none'; ?>"> 
                        ...
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <input type="text" class="erf-input-field" name="rc_site_key" value="<?php echo $options['rc_site_key']; ?>"/>
                                <p class="description"><?php _e('Mandatory for reCAPTCHA. For more details, <a href="https://www.google.com/recaptcha/intro/index.html">Click Here</a>', 'erforms') ?></p>
                            </div>  
                        </div>
                        ...
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <input type="text" class="erf-input-field" name="rc_secret_key" value="<?php echo $options['rc_secret_key']; ?>"/>
                                <p class="description"><?php _e('Mandatory for reCAPTCHA. For more details, <a href="https://www.google.com/recaptcha/intro/index.html">Click Here</a>', 'erforms') ?></p>
                            </div>  
                        </div>
                    </div>
                    ...
                    ?>
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <input type="text" class="erf-input-field" name="gmap_api" value="<?php echo $options['gmap_api']; ?>"/>
