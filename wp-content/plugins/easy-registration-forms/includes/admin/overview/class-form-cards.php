...
class ERForms_Form_Cards extends ERForms_List_Cards {
	...
	public function prepare_items() {
		...
		$out = '<a href="javascript:void(0)" class="erf-card-menu erf-form-card-menu" id="erf-card-menu"><span class="menu-icon"></span></a>';
                ...
                $out .= '<li class="erf-action"><a href="'.admin_url('/admin.php?page=erforms-dashboard&form_id='.$form->ID).'"><img  src="'.ERFORMS_PLUGIN_URL.'/assets/admin/images/settings-card.png"><span>'.__('Settings','erforms').'</span></a></li>';
