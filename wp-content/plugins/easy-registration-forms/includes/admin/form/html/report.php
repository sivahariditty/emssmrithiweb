        ...
        <fieldset>
            ...
            <div class="erf-row">
                ...
                <div class="erf-control">
                    <input type="text" class="erf-input-field" name="name" required value="<?php echo isset($report['name']) ? $report['name'] : ''; ?>"/>
            ...
            <div class="erf-row">
                ...
                <div class="erf-control">
                    <textarea class="erf-input-field" name="description"><?php echo isset($report['description']) ? $report['description'] : ''; ?></textarea>
                                ...
                                <div class="group-wrap">
                                    ...
                                    <div class="erf-report-field-options" style="display:none">
                                        <div class="erf-row">
                                            ...
                                            <div class="erf-control">
                                                <input type="text" class="erf-input-field" name="<?php echo $name; ?>_alias" value="<?php echo $field['alias']; ?>"/>
                                            </div>  
                                        </div>
                                ...
                                <div class="group-wrap">
                                    ...
                                    <div class="erf-report-field-options" style="display:none">
                                        <div class="erf-row">
                                            ...
                                            <div class="erf-control">
                                                <input type="text" class="erf-input-field" name="<?php echo $name; ?>_alias" value="<?php echo $label; ?>"/>
                                            </div>  
                                        </div>
                                ...
                                <div class="group-wrap">
                                    ...
                                    <div class="erf-report-field-options" style="display:none">
                                        <div class="erf-row">
                                            ...
                                            <div class="erf-control">
                                                <input type="text" class="erf-input-field" name="<?php echo $fn; ?>_alias" value="<?php echo $fl; ?>"/>
                                            </div>  
                                        </div>
            ...
            <div class="erf-row">
                ...
                <div class="erf-control">
                    <input type="text" class="erf-input-field" required name="email_subject" value="<?php echo isset($report['email_subject']) ? $report['email_subject'] : $form['title'] . ' Report'; ?>"/>
            ...
            <div class="erf-row">
                ...
                <div class="erf-control">
                    <input required="" id="erf_report_start_date" value="<?php echo isset($report['start_date']) ? $report['start_date'] : ''; ?>" name="start_date" type="text" class="erf-input-field">
            ...
            <div class="erf-row">
                ...
                <div class="erf-control">
                    <input value="<?php echo isset($report['time']) ? $report['time'] : ''; ?>" id="erforms_time" required="" name="time" type="text" class="time ui-timepicker-input erf-input-field" autocomplete="off">
