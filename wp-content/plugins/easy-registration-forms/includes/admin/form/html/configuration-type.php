                    ...
                    <div class="erf-child-rows" style="<?php echo !empty($form['enable_unique_id']) ? '' : 'display:none'; ?>">
                        ...
                        <div class="erf-child-rows" style="<?php echo $form['unique_id_gen_method']=='configure' ? '' : 'display:none'; ?>">
                            ...
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input class="erf-input-field" type="number" value="<?php echo $form['unique_id_index']; ?>"  name="unique_id_index" />
                                </div>  
                            </div>
                            ...
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input class="erf-input-field" type="text" value="<?php echo $form['unique_id_prefix']; ?>"  min="1" name="unique_id_prefix" />
                                </div>  
                            </div>
                            ...
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input class="erf-input-field" type="number" value="<?php echo $form['unique_id_padding']; ?>" min="0" name="unique_id_padding" />
                            ...
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input class="erf-input-field" type="number" value="<?php echo $form['unique_id_offset']; ?>" min="0" name="unique_id_offset" />
                                ...
                                <select name="primary_field" class="erf-input-field">
                                    ...
                                    <?php 
                                          ...
                                          foreach($input_fields as $temp_field): 
                                              if(empty($temp_field['subtype']) || $temp_field['subtype']!='email')
                                                  continue;
                                    ?>
                                            <option value="<?php echo $temp_field['name']; ?>" <?php echo $form['primary_field']==$temp_field['name'] ? 'selected' : ''; ?>><?php echo $temp_field['label']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            ...
                            <div class="erf-control">
                                <select name="primary_contact_name_field"  class="erf-input-field">
                                    ...
                                    <?php foreach($input_fields as $temp_field): ?>
                                            <option value="<?php echo $temp_field['name']; ?>" <?php echo $form['primary_contact_name_field']==$temp_field['name'] ? 'selected' : ''; ?>><?php echo $temp_field['label']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                    ...
                    <?php if (erforms_show_opt_in()): ?>
                                ...
                                <div class="erf-child-rows" style="<?php echo !empty($form['opt_in']) ? '' : 'display:none'; ?>">
                                    <div class="erf-row">
                                        ...
                                        <div class="erf-control">
                                            <input class="erf-input-field" type="text" name="opt_text" value="<?php echo $form['opt_text']; ?>" />
            ...
            <div style="<?php echo $type == 'restrictions' ? '' : 'display:none' ?>">
                ...
                <div class="group-wrap">
                    ...
                    <div class="erf-row">
                        ...
                        <div class="erf-control">
                            <textarea class="erf-input-field" name="access_denied_msg"><?php echo $form['access_denied_msg'] ?></textarea>
                    ...
                    <div class="erf-child-rows" style="<?php echo !empty($form['en_pwd_restriction']) ? '' : 'display:none'; ?>">
                        ...
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <input type="text" class="erf-input-field" name="pwd_res_description" value="<?php echo $form['pwd_res_description']; ?>">
                        ...
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <input type="text" class="erf-input-field" name="pwd_res_question" value="<?php echo $form['pwd_res_question']; ?>">
                        ...
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <input type="text" class="erf-input-field" name="pwd_res_answer" value="<?php echo $form['pwd_res_answer']; ?>">
                        ...
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <input type="text" class="erf-input-field" name="pwd_res_err" value="<?php echo $form['pwd_res_err']; ?>">
                    ...
                    <div class="erf-child-rows" style="<?php echo !empty($form['enable_limit']) ? '' : 'display:none'; ?>">
                        ...
                        <div class="erf-child-rows" style="<?php echo ($form['limit_type']=='date' || $form['limit_type']=='both') ? '' : 'display:none'; ?>">
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input type="text" class="erf-input-field" id="erf_configure_limit_by_date" name="limit_by_date" data-has-child="1" value="<?php echo $form['limit_by_date']; ?>" />
                            ...
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input value="<?php echo isset($form['limit_time']) ? $form['limit_time'] : ''; ?>" id="form_limit_time" name="limit_time" type="text" class="time ui-timepicker-input erf-input-field" autocomplete="off">
                                </div>  
                            </div>
                        </div>
                        ...
                        <div class="erf-child-rows" style="<?php echo ($form['limit_type']=='number' || $form['limit_type']=='both') ? '' : 'display:none'; ?>">
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input type="number" class="erf-input-field" name="limit_by_number" data-has-child="1" value="<?php echo $form['limit_by_number']; ?>" />
                        ...
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <textarea class="erf-input-field" name="limit_message"><?php echo $form['limit_message']; ?></textarea>
                    ...
                    <div class="erf-child-rows" style="<?php echo !empty($form['dis_mul_sub']) ? '' : 'display:none'; ?>">
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <textarea class="erf-input-field" name="mul_sub_denial_msg"><?php echo $form['mul_sub_denial_msg'] ?></textarea>
                    ...
                    <div class="group-wrap">
                        ...
                        <div class="erf-child-rows" style="<?php echo !empty($form['plan_enabled']) ? '' : 'display:none'; ?>">
                            <div class="erf-row">
                                ...
                                <div class="erf-control">
                                    <input type="text" class="erf-input-field" name="payment_header" value="<?php echo $form['payment_header']; ?>" />
            ...
            <div style="<?php echo $type == 'post_sub' ? '' : 'display:none' ?>">
                ...
                <div class="group-wrap">
                    ...
                    <div class="erf-row">
                        ...
                        <div class="erf-control">
                            <input type="url" class="erf-input-field" name="redirect_to" value="<?php echo $form['redirect_to']; ?>">
                            <?php if ($form['type'] == 'reg') : ?>
                    ...
                    <div class="erf-row">
                        ...
                        <div class="erf-control">
                            ...
                            ?>
                            <p class="description"><?php printf(__('This will be displayed after successful submission. You can use <code>[erforms_resend_verification_link label="here"]</code> shortcode to insert <b>Resend Verification</b> link. Make sure to enable notification from <a target="_blank" href="%s">here</a>.', 'erforms'),admin_url('admin.php?page=erforms-dashboard&form_id='.$form['id'].'&tab=notifications&type=user_verification')) ?></p>
                        </div>  
                    </div>
                    ...
                    <div class="erf-child-rows" style="<?php echo !empty($form['enable_external_url']) ? '' : 'display:none'; ?>">
                        <div class="erf-row">
                            ...
                            <div class="erf-control">
                                <input type="text" class="erf-input-field" name="external_url" value="<?php echo $form['external_url']; ?>" />
