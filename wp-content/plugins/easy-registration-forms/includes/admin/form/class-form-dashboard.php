...
class ERForms_Dashboard {
	...
	public function enqueues() {
            ...
            // Registering Scripts
            wp_register_script('erf-form-builder',ERFORMS_PLUGIN_URL.'assets/admin/js/form-builder/form-builder.min.js',array('jquery'));
            wp_deregister_script('wp-polyfill');
            wp_register_script('wp-polyfill',ERFORMS_PLUGIN_URL.'assets/admin/js/form-builder/form-render.min.js',array('jquery'));  
	...
	public function output() {
        ...
        public function save_configuration($form){
            ...
            if(isset($_post['plans'])){
                    $enabled= isset($_post['plans']['enabled']) ? $_post['plans']['enabled'] : array();
                    $required= isset($_post['plans']['required']) ? $_post['plans']['required'] : array();
