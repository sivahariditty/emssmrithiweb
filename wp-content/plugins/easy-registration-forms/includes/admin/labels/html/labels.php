    ...
    <div class="erforms-admin-content">
        ...
        <form method="POST" class="erf-new-form flex-s-e">
            <div class="erf-label-name erf-label-wrap">
                ...
                <div class="label-input"><input class="erf-input-field" required="" type="text" name="label_name" value="<?php echo isset($_POST['label_name']) ? stripslashes(sanitize_text_field($_POST['label_name'])) : '' ?>" /></div>
            </div>
            
            <div class="erf-label-description erf-label-wrap">
                <div class="label"><?php _e('Description','erforms'); ?></div>
                <div class="label-input"><input class="erf-input-field" type="text" name="label_desc" value="<?php echo isset($_POST['label_desc']) ? stripslashes(sanitize_text_field($_POST['label_desc'])) : '' ?>" /></div>
            </div>
            
            <div class="erf-label-color erf-label-wrap">
                <div class="label"><?php _e('Color','erforms'); ?></div>
                <div class="label-input"><input required="" class="jscolor erf-input-field" type="text" value="<?php echo isset($_POST['label_color']) ? $_POST['label_color'] : erforms_rand_hex_color(); ?>"  name="label_color" /></div>
            </div>
                ...
                <?php foreach($labels as $label):?>
                    ...
                    <tr style="display:none" class="erf-label-edit" id="form_row_<?php echo $label['id']; ?>" data-label-id="<?php echo $label['id']; ?>">
                            <td>
                                <div class="erf-label-name erf-label-wrap">
                                    <div class="label"><?php _e('Label Name','erforms'); ?></div>
                                    <div class="label-input"><input id="label" type="text" class="erf-input-field" value="<?php echo $label['name']; ?>" name="label_name" /></div>
                                </div> 
                            </td> 
                            ...
                            <td>
                                <div class="erf-label-description erf-label-wrap">
                                    <div class="label"><?php _e('Description','erforms'); ?></div>
                                    <div class="label-input"><input id="desc" type="text" class="erf-input-field" value="<?php echo $label['desc']; ?>" name="label_desc" /></div>
                                </div>
                            </td>  
                            ...
                            <td>
                                <div class="erf-label-color erf-label-wrap">
                                    <div class="label"><?php _e('Color','erforms'); ?></div>
                                    <div class="label-input"><input id="color" class="jscolor erf-input-field"  value="<?php echo $label['color']; ?>" type="text" name="label_color" /></div>
                                </div>
                            </td>
