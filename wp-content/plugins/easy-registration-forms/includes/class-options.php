...
class ERForms_Options {
    ...
    public static function get_default_options(){
        $options= array('rc_site_key'=>'','rc_secret_key'=>'','after_login_redirect_url'=>'','preview_page'=>0,
                            ...
                            'completed_pay_admin_email_from_name'=>'','pay_completed_admin_email'=>__('Hi Admin, <br><br> Payment completed. Here are the submission details: <br>{{submission_data}}','erforms'),
                            ...
                            'hide_admin_bar'=>0,'allow_login_from'=>'both','gmap_api'=>'','recaptcha_version'=>2);
