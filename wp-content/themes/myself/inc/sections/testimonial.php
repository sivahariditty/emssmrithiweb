 ...
 * @since Myself 1.0.0
 */
if ( ! function_exists( 'myself_add_testimonial_section' ) ) :
    /**
    * Add testimonial section
    *
    *@since Myself 1.0.0
    */
    function myself_add_testimonial_section() {
    	$options = myself_get_theme_options();
        // Check if testimonial is enabled on frontpage
        $testimonial_enable = apply_filters( 'myself_section_status', true, 'testimonial_section_enable' );
        ...
        $section_details = apply_filters( 'myself_filter_testimonial_section_details', $section_details );
        ...
        myself_render_testimonial_section( $section_details );
    }
endif;

if ( ! function_exists( 'myself_get_testimonial_section_details' ) ) :
    /**
    ...
    */
    function myself_get_testimonial_section_details( $input ) {
        $options = myself_get_theme_options();
        ...
        if ( $query->have_posts() ) : 
            while ( $query->have_posts() ) : $query->the_post();
                ...
                $page_post['excerpt']   = myself_trim_content( 20 );
...
add_filter( 'myself_filter_testimonial_section_details', 'myself_get_testimonial_section_details' );


if ( ! function_exists( 'myself_render_testimonial_section' ) ) :
  /**
   ...
   *
   */
   function myself_render_testimonial_section( $content_details = array() ) {
        $options = myself_get_theme_options();
        ...
        <div id="testimonial-slider-section" class="relative page-section">
            ...
            <div class="wrapper testimonial-wrapper">
                <div class="testimonial-slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 1, "infinite": true, "speed": 1500, "dots": false, "arrows":true, "autoplay": true, "draggable": true, "centerMode": true, "focusOnSelect": true, "fade": false }'>
