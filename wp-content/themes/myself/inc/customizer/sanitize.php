...
if ( ! function_exists( 'myself_sanitize_select' ) ) :
	/**
	 ...
	 */
	function myself_sanitize_select( $input, $setting ) {
...
if ( ! function_exists( 'myself_sanitize_image' ) ) :
	/**
	 ...
	 */
	function myself_sanitize_image( $image, $setting ) {
		/*
...
if ( ! function_exists( 'myself_sanitize_number_range' ) ) :
	/**
	 ...
	 *                    the setting default.
	 */
	function myself_sanitize_number_range( $number, $setting ) {
...
if ( ! function_exists( 'myself_sanitize_page' ) ) :
	/**
	* Sanitizes page/post
	...
	* @since Myself 1.0.0
	*/
	function myself_sanitize_page( $input ) {
...
if ( ! function_exists( 'myself_sanitize_checkbox' ) ) :
	/**
	 * Sanitize checkbox.
	 *
	 * @since Myself 1.0.0
	 ...
	 */
	function myself_sanitize_checkbox( $checked ) {
...
if ( ! function_exists( 'myself_sanitize_category_list' ) ) :
	/**
	 ...
	 * @since Myself 1.0.0
	 */
	function myself_sanitize_category_list( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if( ! function_exists( 'myself_sanitize_single_category' ) ) :
	/**
	 ...
	 * @since Myself 1.0.0
	 */
	function myself_sanitize_single_category( $input ) {
		if ( $input != '' ) {
			$args = array(
							'type'			=> 'post',
							'child_of'      => 0,
...
if ( ! function_exists( 'myself_santize_allow_tag' ) ) :
	/**
	 ...
	 */
	function myself_santize_allow_tag( $input ) {
...
if ( ! function_exists( 'myself_sanitize_post_ids' ) ) :
	/**
	* Sanitizes post ids
	* @param  $input entered value
	* @return sanitized output
	...
	* @since Myself 1.0.0
	*/
	function myself_sanitize_post_ids( $input ) {
 ...
 * @return boolean    
 */
function myself_sanitize_switch_control( $input ) {
...
* @since Myself 1.0.0
*/
function myself_sanitize_links( $input ) {
...
* @since Myself 1.0.0
*/
function myself_sanitize_email( $input ) {
...
if ( ! function_exists( 'myself_sanitize_sortable' ) ) :
	/**
	...
	* @since Myself 1.0.0
	*/
	function myself_sanitize_sortable( $input ) {
