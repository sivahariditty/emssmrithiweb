...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'guten' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'guten' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'guten' ),
		'cyrillic'     => __( 'Cyrillic', 'guten' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'guten' ),
		'devanagari'   => __( 'Devanagari', 'guten' ),
		'greek'        => __( 'Greek', 'guten' ),
		'greek-ext'    => __( 'Greek Extended', 'guten' ),
		'khmer'        => __( 'Khmer', 'guten' ),
		'latin'        => __( 'Latin', 'guten' ),
		'latin-ext'    => __( 'Latin Extended', 'guten' ),
		'vietnamese'   => __( 'Vietnamese', 'guten' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'guten' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'guten' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'guten' ),
