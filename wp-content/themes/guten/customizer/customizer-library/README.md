...
To see how this works in practice, please see the [Customizer Library Demo](https://github.com/devinsays/customizer-library-guten) theme.
...
$sections[] = array(
	'id' => 'example', // Required
	'title' => __( 'Example Section', 'guten' ), // Required
...
$options['example-panel-text'] = array(
	...
	'label'   => __( 'Example Text Input', 'guten' ),
	'section' => $section,
	'type'    => 'text',
);
~~~
...
$options['example-url'] = array(
	'id' => 'example-url',
	'label'   => __( 'Example URL Input', 'guten' ),
	'section' => $section,
	'type'    => 'url',
);
~~~
...
$options['example-checkbox'] = array(
	'id' => 'example-checkbox',
	'label'   => __( 'Example Checkbox', 'guten' ),
	'section' => $section,
	'type'    => 'checkbox',
	'default' => 0,
);
...
$options['example-dropdown-pages'] = array(
	...
	'label'   => __( 'Example Drop Down Pages', 'guten' ),
	'section' => $section,
	'type'    => 'dropdown-pages',
	'default' => ''
);
...
$options['example-textarea'] = array(
	'id' => 'example-textarea',
	'label'   => __( 'Example Textarea', 'guten' ),
	'section' => $section,
	'type'    => 'textarea',
	'default' => __( 'Example textarea text.', 'guten'),
);
~~~
...
$options['example-range'] = array(
	'id' => 'example-range',
	'label'   => __( 'Example Range Input', 'guten' ),
	'section' => $section,
	'type'    => 'range',
	'input_attrs' => array(
        'min'   => 0,
...
https://github.com/devinsays/customizer-library-guten/blob/master/inc/customizer-options.php
...
function guten_fonts() {
	...
	// Load Google Fonts
	wp_enqueue_style( 'guten_fonts', $font_uri, array(), null, 'screen' );

}
add_action( 'wp_enqueue_scripts', 'guten_fonts' );
~~~
